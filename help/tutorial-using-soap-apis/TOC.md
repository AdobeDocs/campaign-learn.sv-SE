...
+ [Självstudie - Använda API:er för Campaign SOAP](/help/tutorial-using-soap-apis/introduction.md)
...
+ Steg 4 - Skapa en artikelvarningsleverans{#article-alert-email}
   + [Skapa leverans av artikelaviseringar](/help/tutorial-using-soap-apis/create-article-alert-delivery-overview.md)
   + [Del 1 - Frågeartiklar och mottagarprenumerationsvärden](/help/tutorial-using-soap-apis/query-articles-and-recipient-subscription-values.md)
   + [Del 2 - Koppla kolumner och skicka e-postleverans](/help/tutorial-using-soap-apis/join-columns-and-send-automated-email-delivery.md)
