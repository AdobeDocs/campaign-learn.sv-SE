...
+ Kampanjsamordning {#campaign-orchestration}
   ...
   + [Introduktion till kampanjer i flera och flera kampanjer](/help/orchestrate-campaigns/introduction-to-cross-and-multi-channel-campaigns.md)
   + [Skapa flerkanalskampanjer](/help/orchestrate-campaigns/multi-channel-campaigns.md)
   + [Skapa flerkanalskampanjer](/help/orchestrate-campaigns/cross-channel-campaigns.md)
...
+ Skicka meddelanden{#sending-messages}
   + E-post {#email}
      + [Skicka och validera korrektur för e-postleverans ](/help/send-messages/email/send-and-validate-proofs.md)
      + [Använda kontrollgrupper](/help/send-messages/email/use-control-groups.md)
      + [Felsöka e-postleveransproblem](/help/send-messages/email/troubleshoot-email-delivery-issues.md)
   ...
   + Tryck {#push}
      + [Installera mobilappskanalen](/help/send-messages/mobile/install-the-mobile-app.md)
   ...
   + Direktmeddelande {#direct-mail}
      + [Skapa direktreklam](/help/send-messages/direct-mail/create-direct-mail-deliveries.md)
...
+ Processhantering och automatisering{#process-management}
   ...
   + [Konfigurera anrikningsaktiviteter](/help/process-management/enrichment-activity.md)
...
+ Övervakning {#monitoring}
   + [Färgdiagram över arbetsflöde](/help/monitoring/workflow-heatmap.md)
